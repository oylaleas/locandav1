...
| Tradução editorial em espanhol dos textos de conteúdo | `src/data/content.ts`, `src/data/tours.ts`, `src/data/wellness.ts` | Interface ES integrada; textos editoriais ainda usam fallback pt-BR até revisão humana **[A VALIDAR]** |
