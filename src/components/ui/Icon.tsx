...
const PATHS: Record<IconName, ReactElement> = {
  ...
  buggy: (
    <>
      ...
      <path d="M4.5 15.5 7 9.2h8.2L19.5 15.5" />
      <path d="M9.2 9.2 10.2 6.6h4.2l1 2.6" />
      <path d="M3.5 15.5h17" />
    </>
  ),
  atv: (
    <>
      <circle cx="6.8" cy="16.6" r="2.3" />
      <circle cx="17.2" cy="16.6" r="2.3" />
      <path d="M5 15.6h14l-1.4-5.8H8.2L5 15.6Z" />
      <path d="M10.2 9.8V7.2h4.2" />
      <path d="M12.3 9.8V7.8" />
    </>
  ),
  horse: (
    <>
      <path d="M6 19.2v-6.2c0-2.1 1.1-3.6 3.1-4.3L11 5.4s.7 1.9 2.1 2.3c1.5.4 2.8.1 4-.8l1.6 1.5c-1.3 1.3-2.1 2.9-2.1 4.7v6.1" />
      <path d="M8.6 19.2v-3.4" />
      <path d="M15.2 19.2v-3.4" />
      <path d="M10.4 8.4c.2 1.1-.3 2.2-1.3 2.8" />
    </>
  ),
  kayak: (
    <>
      <path d="M3 14.4c3.1-1.9 6.2-2.8 9-2.8s5.9.9 9 2.8c-3.1 1.9-6.2 2.8-9 2.8s-5.9-.9-9-2.8Z" />
      <path d="M8.2 8.2 16 18" />
      <path d="M14.4 7.4 16.2 9" />
    </>
  ),
  bike: (
    <>
      <circle cx="6.4" cy="16.2" r="3.1" />
      <circle cx="17.6" cy="16.2" r="3.1" />
      <path d="M6.4 16.2h4.6l3.1-6.8h3.2" />
      <path d="M11 16.2 13.8 9.4" />
      <path d="M12.4 9.4h3.4" />
    </>
  ),
};
