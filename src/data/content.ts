...
export const SITE_IDENTITY: SiteIdentity = {
  ...
  attractSubhead: {
    ...
    es: "Hotel y experiencias en la Ilha do Guajiru, Itarema — Ceará.",
  },
  attractCallToAction: {
    'pt-BR': 'Toque na tela para começar',
    en: 'Touch the screen to begin',
    it: 'Tocca lo schermo per iniziare',
    es: 'Toca la pantalla para comenzar',
  },
  homeWelcome: {
    'pt-BR': 'Bem-vindo',
    en: 'Welcome',
  ...
  homeIntro: {
    ...
    es: 'Elige por dónde quieres empezar.',
  },
  contact: {
    addressLine: {
      ...
      es: 'Av. Costeira, S/N — Ilha do Guajiru, Itarema, CE — CEP 62590-000, Brasil',
    },
    phone: {
...
export const QR_TARGETS: QrTarget[] = [
  ...
  },
  {
    ...
    instruction: {
      ...
      es: 'Apunta la cámara de tu celular para seguir viendo las fotos.',
    },
    destinationLabel: {
      'pt-BR': 'Instagram — @locandadeiventi',
      en: 'Instagram — @locandadeiventi',
      it: 'Instagram — @locandadeiventi',
      es: 'Instagram — @locandadeiventi',
    },
  },
  {
    id: 'qr-reservas',
...
export const CONTENT_SECTIONS: ContentSection[] = [
  {
    ...
    order: 1,
    icon: 'info',
    title: { 'pt-BR': 'A Locanda', en: 'The Locanda', it: 'La Locanda', es: 'La Locanda' },
    tagline: {
      'pt-BR': 'Quem somos',
      en: 'Who we are',
      it: 'Chi siamo',
    ...
    summary: {
      ...
      es: 'Hotel frente a una bahía de aguas tranquilas ("flat water"), ideal para deportes acuáticos y contacto con la naturaleza. Arquitectura moderna con detalles rústicos.',
    },
    heroImageId: 'img-01',
    ...
    blocks: [
      {
        ...
        text: {
          ...
          es: 'Locanda dei Venti es un hotel frente a una bahía de aguas tranquilas ("flat water"), ideal para deportes acuáticos y contacto con la naturaleza. La arquitectura moderna se combina con detalles rústicos, en una estructura con 20 suites completas, restaurante, bar y piscina.',
        },
      },
      {
        type: 'paragraph',
        text: {
          ...
          es: 'Misión — atender a los huéspedes con excelencia, solicitud y buen humor, garantizando una estadía cómoda y sin preocupaciones, contribuyendo también al turismo local y a la preservación ambiental.',
        },
      },
      {
        type: 'paragraph',
        text: {
          ...
          es: 'Visión — ser referencia en atención y estructura, buscando modernización constante y buenas relaciones humanas.',
        },
      },
      {
        type: 'paragraph',
        text: {
          ...
          es: 'Valores — compromiso, excelencia de calidad, profesionalismo, optimismo, ética, innovación, responsabilidad social y ambiental y valoración de los recursos humanos.',
        },
      },
    ],
    facts: [
      {
        ...
        icon: 'bed',
        label: { 'pt-BR': 'Suítes', en: 'Suites', it: 'Suite', es: 'Suites' },
        value: { 'pt-BR': '20 suítes completas', en: '20 full suites', it: '20 suite complete', es: '20 suites completas' },
      },
      {
        id: 'fact-locanda-terreno',
        icon: 'map-pin',
        label: { 'pt-BR': 'Terreno', en: 'Land', it: 'Terreno', es: 'Terreno' },
        value: { 'pt-BR': '2.500 m²', en: '2,500 m²', it: '2.500 m²', es: '2.500 m²' },
      },
      {
        id: 'fact-locanda-construido',
        icon: 'info',
        label: { 'pt-BR': 'Área construída', en: 'Built area', it: 'Superficie costruita', es: 'Área construida' },
        value: { 'pt-BR': '1.300 m²', en: '1,300 m²', it: '1.300 m²', es: '1.300 m²' },
      },
      {
        id: 'fact-locanda-distancias',
        icon: 'compass',
        label: { 'pt-BR': 'Localização', en: 'Location', it: 'Posizione', es: 'Ubicación' },
        value: {
          ...
          es: '~210 km de Fortaleza · ~60 km de Jericoacoara',
        },
      },
    ],
  ...
  },
  {
    ...
    order: 2,
    icon: 'bed',
    title: { 'pt-BR': 'Acomodações', en: 'Accommodation', it: 'Camere', es: 'Alojamiento' },
    tagline: {
    ...
    summary: {
      ...
      es: '20 suites climatizadas en cuatro categorías — Frente Mar y Frente Jardín, piso superior y planta baja.',
    },
    heroImageId: 'img-05',
    contentPending: false,
    blocks: [
      {
        ...
        text: {
          ...
          es: 'Son 20 suites climatizadas, con capacidad para hasta 3 personas cada una, en cuatro categorías: Suite Superior Frente Mar, Suite Inferior Frente Mar, Suite Superior Frente Jardín y Suite Inferior Frente Jardín.',
        },
      },
      {
        type: 'paragraph',
        text: {
          ...
          es: 'Suite Superior Frente Mar — 6 unidades, piso superior, vista total a la barra/mar.',
        },
      },
      {
        type: 'list',
        title: { 'pt-BR': 'Destaques da suíte', en: 'Suite highlights', it: 'Punti salienti della suite', es: 'Destacados de la suite' },
        items: [
          {
            'pt-BR': '23 m²',
            en: '23 m²',
      ...
      },
      {
        ...
        text: {
          ...
          es: 'Suite Inferior Frente Mar — 6 unidades, planta baja, vista total a la barra/mar.',
        },
      },
      {
        type: 'list',
      ...
      },
      {
        ...
        text: {
          ...
          es: 'Los detalles de las suites Frente Jardín (Superior e Inferior) aún no se publicaron en el sitio oficial. [POR CONFIRMAR CON LA GESTIÓN DE LA LOCANDA]',
        },
      },
    ],
    facts: [
      {
        ...
        value: {
          ...
          es: '20 climatizadas · hasta 3 personas',
        },
      },
      {
        id: 'fact-acomodacoes-categorias',
        icon: 'info',
        label: { 'pt-BR': 'Categorias', en: 'Categories', it: 'Categorie', es: 'Categorías' },
        value: { 'pt-BR': '4 — Frente Mar e Frente Jardim', en: '4 — Sea Front and Garden Front', it: '4 — fronte mare e fronte giardino', es: '4 — Frente Mar y Frente Jardín' },
      },
      {
        id: 'fact-acomodacoes-superior',
        icon: 'info',
        label: { 'pt-BR': 'Superior Frente Mar', en: 'Upper Sea Front', it: 'Superior fronte mare', es: 'Superior frente al mar' },
        value: { 'pt-BR': '6 unidades · 23 m²', en: '6 units · 23 m²', it: '6 unità · 23 m²', es: '6 unidades · 23 m²' },
      },
      {
        id: 'fact-acomodacoes-inferior',
        icon: 'info',
        label: { 'pt-BR': 'Inferior Frente Mar', en: 'Ground Sea Front', it: 'Inferior fronte mare', es: 'Planta baja frente al mar' },
        value: { 'pt-BR': '6 unidades · 21 m²', en: '6 units · 21 m²', it: '6 unità · 21 m²', es: '6 unidades · 21 m²' },
      },
    ],
  ...
  },
  {
    ...
    order: 3,
    icon: 'dining',
    title: { 'pt-BR': 'Gastronomia', en: 'Dining', it: 'Ristorazione', es: 'Gastronomía' },
    tagline: {
      'pt-BR': 'À mesa',
      en: 'At the table',
      it: 'A tavola',
    ...
    summary: {
      ...
      es: 'Restaurante à la carte con menú firmado por el Chef Léo Parente, especializado en mariscos — y el Nau Rooftop Lounge para el final de la tarde.',
    },
    heroImageId: 'img-06',
    contentPending: false,
    blocks: [
      {
        ...
        text: {
          ...
          es: 'El restaurante de la Locanda es à la carte, con menú firmado por el Chef Léo Parente y especializado en mariscos.',
        },
      },
      {
        type: 'paragraph',
        text: {
          ...
          es: 'El bar reúne bebidas variadas, y el Nau Rooftop Lounge es el nuevo espacio de final de tarde de la Locanda, uniendo buena música, confort y sofisticación en la Ilha do Guajiru.',
        },
      },
      {
        type: 'paragraph',
        text: {
          ...
          es: 'El desayuno está incluido en la tarifa.',
        },
      },
    ],
    facts: [
      {
        ...
        icon: 'dining',
        label: { 'pt-BR': 'Chef', en: 'Chef', it: 'Chef', es: 'Chef' },
        value: { 'pt-BR': 'Léo Parente', en: 'Léo Parente', it: 'Léo Parente', es: 'Léo Parente' },
      },
      {
        id: 'fact-gastronomia-cardapio',
        icon: 'dining',
        label: { 'pt-BR': 'Especialidade', en: 'Specialty', it: 'Specialità', es: 'Especialidad' },
        value: { 'pt-BR': 'Frutos do mar', en: 'Seafood', it: 'Frutti di mare', es: 'Mariscos' },
      },
      {
        id: 'fact-gastronomia-cafe',
        icon: 'check',
        label: { 'pt-BR': 'Café da manhã', en: 'Breakfast', it: 'Colazione', es: 'Desayuno' },
        value: { 'pt-BR': 'Incluso na diária', en: 'Included in the rate', it: 'Inclusa nella tariffa', es: 'Incluido en la tarifa' },
      },
      {
        id: 'fact-gastronomia-rooftop',
        icon: 'sun',
        label: { 'pt-BR': 'Nau Rooftop Lounge', en: 'Nau Rooftop Lounge', it: 'Nau Rooftop Lounge', es: 'Nau Rooftop Lounge' },
        value: {
          'pt-BR': 'Espaço de fim de tarde',
          en: 'End-of-day space',
          it: 'Spazio fine giornata',
          es: 'Espacio de final de tarde',
        },
      },
    ],
  ...
  },
  {
    ...
    order: 4,
    icon: 'compass',
    title: { 'pt-BR': 'Experiências', en: 'Experiences', it: 'Esperienze', es: 'Experiencias' },
    tagline: {
    ...
    summary: {
      ...
      es: 'Deportes acuáticos favorecidos por la bahía de aguas tranquilas: kitesurf, wakeboard, windsurf, SUP y canotaje.',
    },
    heroImageId: 'img-03',
    contentPending: false,
    blocks: [
      {
        ...
        text: {
          ...
          es: 'La bahía de aguas tranquilas ("flat water") frente a la Locanda favorece deportes acuáticos como kitesurf, wakeboard, windsurf, SUP y canotaje.',
        },
      },
      {
        type: 'paragraph',
        text: {
          ...
          es: 'La Locanda mantiene una alianza con Isla Kite Center para clases de kitesurf y ofrece espacio para guardar equipos de kite y deportes acuáticos.',
        },
      },
      {
        type: 'list',
        title: { 'pt-BR': 'Esportes aquáticos', en: 'Water sports', it: 'Sport acquatici', es: 'Deportes acuáticos' },
        items: [
          { 'pt-BR': 'Kitesurf', en: 'Kitesurf', it: 'Kitesurf', es: 'Kitesurf' },
          { 'pt-BR': 'Wakeboard', en: 'Wakeboard', it: 'Wakeboard', es: 'Wakeboard' },
          { 'pt-BR': 'Windsurf', en: 'Windsurf', it: 'Windsurf', es: 'Windsurf' },
          { 'pt-BR': 'SUP', en: 'SUP', it: 'SUP', es: 'SUP' },
          { 'pt-BR': 'Canoagem', en: 'Canoeing', it: 'Canoa', es: 'Canotaje' },
        ],
      },
      {
        type: 'paragraph',
        text: {
          ...
          es: 'Los paseos y recorridos de la región (Atardecer, Moitas de Icaraí, Almofala e Ilha do Guajiru) están en el área "Experiencias y paseos" de este tótem.',
        },
      },
    ],
    facts: [
      {
        ...
        icon: 'compass',
        label: { 'pt-BR': 'Esportes', en: 'Sports', it: 'Sport', es: 'Deportes' },
        value: {
          ...
          es: 'Kitesurf · Wakeboard · Windsurf · SUP · Canotaje',
        },
      },
      {
        id: 'fact-experiencias-soulkite',
        icon: 'info',
        label: { 'pt-BR': 'Aulas de kitesurf', en: 'Kitesurf lessons', it: 'Lezioni di kitesurf', es: 'Clases de kitesurf' },
        value: { 'pt-BR': 'Isla Kite Center', en: 'Isla Kite Center', it: 'Isla Kite Center', es: 'Isla Kite Center' },
      },
    ],
  ...
  },
  {
    ...
    order: 5,
    icon: 'leaf',
    title: { 'pt-BR': 'Arredores', en: 'Surroundings', it: 'Dintorni', es: 'Alrededores' },
    tagline: {
      'pt-BR': 'O território',
      en: 'The territory',
      it: 'Il territorio',
    ...
    summary: {
      ...
      es: 'La Ilha do Guajiru está en Itarema, en el litoral oeste de Ceará — a unos 210 km de Fortaleza y 60 km de Jericoacoara.',
    },
    heroImageId: 'img-04',
    contentPending: false,
    blocks: [
      {
        ...
        text: {
          ...
          es: 'La Locanda está en la Ilha do Guajiru, en Itarema, en el litoral oeste de Ceará: a unos 210 km de Fortaleza y 60 km de Jericoacoara.',
        },
      },
      {
        type: 'paragraph',
        text: {
          ...
          es: 'Los puntos de interés y los paseos de la región están reunidos en el área "Experiencias y paseos" de este tótem.',
        },
      },
    ],
    facts: [
      {
        ...
        icon: 'map-pin',
        label: { 'pt-BR': 'Fortaleza', en: 'Fortaleza', it: 'Fortaleza', es: 'Fortaleza' },
        value: { 'pt-BR': '~210 km', en: '~210 km', it: '~210 km', es: '~210 km' },
      },
      {
        id: 'fact-arredores-jeri',
        icon: 'map-pin',
        label: { 'pt-BR': 'Jericoacoara', en: 'Jericoacoara', it: 'Jericoacoara', es: 'Jericoacoara' },
        value: { 'pt-BR': '~60 km', en: '~60 km', it: '~60 km', es: '~60 km' },
      },
      {
        id: 'fact-arredores-regiao',
        icon: 'leaf',
        label: { 'pt-BR': 'Região', en: 'Region', it: 'Regione', es: 'Región' },
        value: {
          'pt-BR': 'Itarema · Litoral Oeste do Ceará',
          en: 'Itarema · West Coast of Ceará',
          it: 'Itarema · Costa occidentale del Ceará',
          es: 'Itarema · Litoral oeste de Ceará',
        },
      },
    ],
  ...
  },
  {
    ...
    order: 6,
    icon: 'map-pin',
    title: { 'pt-BR': 'Como chegar', en: 'Getting here', it: 'Come arrivare', es: 'Cómo llegar' },
    tagline: {
    ...
    summary: {
      ...
      es: 'Av. Costeira, S/N — Ilha do Guajiru, Itarema, CE — CEP 62590-000. A unos 210 km de Fortaleza y 60 km de Jericoacoara.',
    },
    heroImageId: 'img-02',
    contentPending: false,
    blocks: [
      {
        ...
        text: {
          ...
          es: 'Dirección: Av. Costeira, S/N — Ilha do Guajiru, Itarema, CE — CEP 62590-000, Brasil.',
        },
      },
      {
        type: 'paragraph',
        text: {
          ...
          es: 'La Locanda queda a unos 210 km de Fortaleza y 60 km de Jericoacoara.',
        },
      },
      {
        type: 'paragraph',
        text: {
          ...
          es: 'Teléfono/WhatsApp: +55 88 99219-1175 · E-mail: locanda@locandadeiventi.com.br',
        },
      },
    ],
    facts: [
      {
        id: 'fact-endereco',
        icon: 'map-pin',
        label: { 'pt-BR': 'Endereço', en: 'Address', it: 'Indirizzo', es: 'Dirección' },
        value: {
          ...
          es: 'Av. Costeira, S/N — Ilha do Guajiru, Itarema/CE',
        },
      },
      {
        id: 'fact-cep',
        icon: 'info',
        label: { 'pt-BR': 'CEP', en: 'Postal code', it: 'CAP', es: 'Código postal' },
        value: { 'pt-BR': '62590-000', en: '62590-000', it: '62590-000', es: '62590-000' },
      },
      {
        id: 'fact-telefone',
        icon: 'chat',
        label: { 'pt-BR': 'Telefone/WhatsApp', en: 'Phone/WhatsApp', it: 'Telefono/WhatsApp', es: 'Teléfono/WhatsApp' },
        value: { 'pt-BR': '+55 88 99219-1175', en: '+55 88 99219-1175', it: '+55 88 99219-1175', es: '+55 88 99219-1175' },
      },
      {
        id: 'fact-email',
        icon: 'globe',
        label: { 'pt-BR': 'E-mail', en: 'E-mail', it: 'E-mail', es: 'E-mail' },
        value: {
          'pt-BR': 'locanda@locandadeiventi.com.br',
          en: 'locanda@locandadeiventi.com.br',
          it: 'locanda@locandadeiventi.com.br',
  ...
  },
  {
    ...
    title: {
      ...
      es: 'Comodidades para nuestros huéspedes',
    },
    tagline: {
      'pt-BR': 'Facilidades',
      en: 'Facilities',
    ...
    summary: {
      ...
      es: 'Wi-Fi, estacionamiento, bar y restaurante, beach tennis, fitness, yoga y más.',
    },
    heroImageId: 'img-01',
    contentPending: false,
    blocks: [
      {
        ...
        items: [
          { 'pt-BR': 'Wi-Fi gratuito', en: 'Free Wi-Fi', it: 'Wi-Fi gratuito', es: 'Wi-Fi gratuito' },
          {
          ...
          { 'pt-BR': 'Bar & Restaurante', en: 'Bar & Restaurant', it: 'Bar & Ristorante', es: 'Bar y restaurante' },
          {
            'pt-BR': 'Quadra de Beach Tennis',
            en: 'Beach Tennis Court',
            it: 'Campo di beach tennis',
            es: 'Cancha de beach tennis',
          },
          { 'pt-BR': 'Espaço Fitness', en: 'Fitness Space', it: 'Spazio fitness', es: 'Espacio fitness' },
          {
          ...
          { 'pt-BR': 'Piquenique*', en: 'Picnic*', it: 'Picnic*', es: 'Picnic*' },
          {
            'pt-BR': 'Auxílio Beach Boy Gratuito',
            en: 'Free Beach Boy Services',
            it: 'Assistenza beach boy gratuita',
            es: 'Asistencia beach boy gratuita',
          },
          { 'pt-BR': 'Berço Gratuito', en: 'Free Baby Crib', it: 'Culla gratuita', es: 'Cuna gratuita' },
          { 'pt-BR': 'Violão', en: 'Acoustic Guitar', it: 'Chitarra acustica', es: 'Guitarra acústica' },
          {
            'pt-BR': 'Desenhos para Colorir para Crianças',
            en: 'Drawings for Children',
            it: 'Disegni da colorare per bambini',
            es: 'Dibujos para colorear para niños',
          },
        ],
      },
      {
        ...
        text: {
          ...
          es: '*Atención: algunos de los servicios descritos no son gratuitos y tienen tarifas propias definidas por el prestador. Consulte disponibilidad y valores en recepción.',
        },
      },
    ],
    facts: [
      {
        ...
        icon: 'check',
        label: { 'pt-BR': 'Comodidades', en: 'Amenities', it: 'Servizi', es: 'Comodidades' },
        value: { 'pt-BR': '12 itens', en: '12 items', it: '12 voci', es: '12 ítems' },
      },
    ],
  ...
  },
  {
    ...
    order: 8,
    icon: 'cocktail',
    title: { 'pt-BR': 'Happy Hour', en: 'Happy Hour', it: 'Happy Hour', es: 'Happy Hour' },
    tagline: {
      'pt-BR': 'Fim de tarde na Locanda',
      en: 'Late afternoon at the Locanda',
      it: 'Fine giornata alla Locanda',
      es: 'Final de tarde en la Locanda',
    },
    summary: {
      'pt-BR':
      ...
      es: 'Happy Hour en la Locanda: viernes de 18h a 21h y sábados de 16h a 20h.',
    },
    heroImageId: 'img-06',
    contentPending: false,
    blocks: [
      {
        type: 'list',
        title: { 'pt-BR': 'Sexta-feira · 18h às 21h', en: 'Friday · 6 pm to 9 pm', it: 'Venerdì · 18-21', es: 'Viernes · 18h a 21h' },
        items: [
          { 'pt-BR': 'Balde de Heineken 330ml — R$ 48', en: 'Heineken bucket 330ml — R$ 48', it: 'Secchiello Heineken 330ml — R$ 48', es: 'Balde de Heineken 330ml — R$ 48' },
          { 'pt-BR': 'Balde de Stella Artois 330ml — R$ 48', en: 'Stella Artois bucket 330ml — R$ 48', it: 'Secchiello Stella Artois 330ml — R$ 48', es: 'Balde de Stella Artois 330ml — R$ 48' },
        ],
      },
      {
        type: 'list',
        title: { 'pt-BR': 'Sábado · 16h às 20h', en: 'Saturday · 4 pm to 8 pm', it: 'Sabato · 16-20', es: 'Sábado · 16h a 20h' },
        items: [
          { 'pt-BR': 'Caipirinha Ypióca (1 sabor) — R$ 11', en: 'Ypióca caipirinha (1 flavour) — R$ 11', it: 'Caipirinha Ypióca (1 gusto) — R$ 11', es: 'Caipiriña Ypióca (1 sabor) — R$ 11' },
          { 'pt-BR': 'Taça de espumante — R$ 17', en: 'Glass of sparkling wine — R$ 17', it: 'Calice di spumante — R$ 17', es: 'Copa de espumante — R$ 17' },
          { 'pt-BR': 'Bons Ventos — R$ 20', en: 'Bons Ventos — R$ 20', it: 'Bons Ventos — R$ 20', es: 'Bons Ventos — R$ 20' },
          { 'pt-BR': 'Croquetes de arraia — R$ 25', en: 'Stingray croquettes — R$ 25', it: 'Crocchette di razza — R$ 25', es: 'Croquetas de raya — R$ 25' },
          { 'pt-BR': 'Toasts de carne de sol — R$ 25', en: 'Sun-dried beef toasts — R$ 25', it: 'Toast di carne secca — R$ 25', es: 'Tostadas de carne seca — R$ 25' },
        ],
      },
    ],
    facts: [
      {
        ...
        icon: 'clock',
        label: { 'pt-BR': 'Sextas', en: 'Fridays', it: 'Venerdì', es: 'Viernes' },
        value: { 'pt-BR': '18h às 21h', en: '6 pm to 9 pm', it: '18-21', es: '18h a 21h' },
      },
      {
        id: 'fact-happy-hour-sabados',
        icon: 'clock',
        label: { 'pt-BR': 'Sábados', en: 'Saturdays', it: 'Sabato', es: 'Sábados' },
        value: { 'pt-BR': '16h às 20h', en: '4 pm to 8 pm', it: '16-20', es: '16h a 20h' },
      },
    ],
  ...
  },
  {
    ...
    summary: {
      ...
      es: 'Transfer, niñera, cena romántica, picnic, servicios de belleza y eventos privados.',
    },
    heroImageId: 'img-07',
    contentPending: false,
    blocks: [
      {
        type: 'list',
        title: { 'pt-BR': 'Serviços', en: 'Services', it: 'Servizi', es: 'Servicios' },
        items: [
          { 'pt-BR': 'Transfer', en: 'Transfer', it: 'Transfer', es: 'Transfer' },
          { 'pt-BR': 'Babá', en: 'Babysitting', it: 'Babysitter', es: 'Niñera' },
          { 'pt-BR': 'Jantar Romântico', en: 'Romantic Dinner', it: 'Cena romantica', es: 'Cena romántica' },
          { 'pt-BR': 'Piquenique', en: 'Picnic', it: 'Picnic', es: 'Picnic' },
          {
            ...
            es: 'Servicios de belleza — Manicura, peluquería, maquillaje',
          },
          { 'pt-BR': 'Eventos privativos', en: 'Private events', it: 'Eventi privati', es: 'Eventos privados' },
        ],
      },
      {
        type: 'paragraph',
        text: {
          ...
          es: 'Todos los servicios anteriores tienen tarifa definida por el prestador. Consulte en recepción.',
        },
      },
    ],
    facts: [
      {
        ...
        icon: 'info',
        label: { 'pt-BR': 'Tarifas', en: 'Rates', it: 'Tariffe', es: 'Tarifas' },
        value: {
          ...
          es: 'Definidas por el prestador — consulte en recepción',
        },
      },
    ],
  ...
  },
  {
    ...
    order: 10,
    icon: 'kite',
    title: { 'pt-BR': 'Isla Kite Center', en: 'Isla Kite Center', it: 'Isla Kite Center', es: 'Isla Kite Center' },
    tagline: {
      'pt-BR': 'Kitesurf na baía',
      en: 'Kitesurf on the bay',
      it: 'Kitesurf sulla baia',
      es: 'Kitesurf en la bahía',
    },
    summary: {
      'pt-BR':
      ...
      es: 'Clases de kitesurf y wingfoil, alquiler de equipo, supervisión, downwinds y tienda — con Isla Kite Center.',
    },
    heroImageId: 'img-03',
    contentPending: false,
    blocks: [
      {
        ...
        text: {
          ...
          es: 'La bahía de aguas tranquilas ("flat water") frente a la Locanda favorece el kitesurf y el wingfoil. La Locanda mantiene una alianza con Isla Kite Center, que ofrece:',
        },
      },
      {
        type: 'list',
        ...
        items: [
          {
            ...
            es: 'Clases de kitesurf y wingfoil',
          },
          {
      ...
      },
      {
        ...
        text: {
          ...
          es: 'Horarios, valores, instructores y contactos de Isla Kite Center: [CONTENIDO DEL KITE CENTER POR DEFINIR]',
        },
      },
    ],
    facts: [
      ...
      },
      {
        id: 'fact-kite-guarda',
        icon: 'check',
        label: { 'pt-BR': 'Equipamentos', en: 'Equipment', it: 'Attrezzature', es: 'Equipos' },
        value: {
          ...
          es: 'Espacio para guardar kites y equipos',
        },
      },
    ],
    galleryImageIds: ['img-03', 'img-04'],
